...
plot ARG1.'/50-percent.csv' using 1:2 with boxes title "", \
  ARG1.'/50-percent.csv' using 1:3 with lines title "5-year average" lw 4, \
  ARG1.'/50-percent.csv' using 1:4 with lines title "All-time average" lw 4
