...
# title
set title "Number of persons doing 50% of the commits" font ",48"
# where's the legend
set key top left
...
set timefmt "%Y-%m-%d"
set xdata time
set xtics rotate 3500*24*365.25 nomirror in
unset mxtics
...
plot 'tmp/50-percent.csv' using 1:2 with boxes title "", \
  ...
  'tmp/50-percent.csv' using 1:4 with lines title "All-time accumulated" lw 4
