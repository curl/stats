...
plot 'stats/h1-reports.md' using 1:2 with boxes title "All reports" fc 'red', 'stats/h1-reports.md' using (strcol(1)[1:8].dayoffset):3 with boxes title "Confirmed vulnerabilities" fc '#c06060', \
 'stats/h1-reports.md' using 1:2:2 with labels title "" offset 0,.5 font ", 24" tc lt 1, \
 'stats/h1-reports.md' using 1:3:3 with labels title "" offset 5,.5 font ", 24" tc lt 6
