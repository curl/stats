...
plot 'stats/h1-reports.md' using 1:2 with boxes title "All reports" fc 'red', 'stats/h1-reports.md' using (strcol(1)[1:8].dayoffset):3 with boxes title "Confirmed vulnerabilities" fc 'green', \
