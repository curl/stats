...
plot ARG1.'/authors-percent-90.csv' using 1:2 smooth bezier with lines linestyle 1 title "90 percent", \
 ARG1.'/authors-percent-80.csv' using 1:2 smooth bezier with lines linestyle 2 title "80 percent", \
 ARG1.'/authors-percent-70.csv' using 1:2 smooth bezier with lines linestyle 3 title "70 percent"
