...
plot ARG1.'/lines-per-month.csv' using 1:2 with lines linestyle 1 title "Line delta this month", \
 ARG1.'/lines-per-month.csv' using 1:3 with lines linestyle 2 title "12 month average"
