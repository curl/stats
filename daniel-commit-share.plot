...
plot  ARG1.'/daniel-commit-share.csv' using 1:3 with boxes linestyle 3 title "Monthly share of commits", \
ARG1.'/daniel-commit-share.csv' using 1:2 with lines linestyle 1 title "total share of commits"
