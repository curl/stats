...
plot 'tmp/CI.csv' using 1:2 with lines lw 3 title "All CI jobs", \
 ...
 'tmp/CI.csv' using 1:6 with lines lw 3 title "Azure", \
 'tmp/CI.csv' using 1:7 with lines lw 3 title "Github"
