...
docs-per-kloc = $output/lines-per-docs.svg
...
first-timer-authors = $output/firsttimers.svg
...
severity-distribution = $output/severity.svg
...
time-to-fix = $output/cve-fixtime.svg
todo = $output/todo-over-time.svg
top-40-authors = $output/top-remains.svg
...
docs-per-kloc = $temp/lines-per-docs.csv
...
first-timer-authors = $temp/firsttimers.csv
...
severity-distribution = $temp/severity.csv
...
time-to-fix = $temp/cve-fixtime.csv
todo = $temp/todo-over-time.csv
top-40-authors = $temp/top-remains.csv
