...
perl stats/c-vuln-code.pl $webroot > $temp/c-vuln-code.csv
gnuplot -c stats/c-vuln-code.plot > $output/c-vuln-code.svg
...
lines-of-code = $output/lines-over-time.svg
lines-of-code-delta = $output/lines-per-month.svg
...
remaining-authors = $output/authorremains.svg
remaining-authors-toplist = $output/authorremains-top.svg
...
vulnerabilities-per-time = $output/vulns-plot.svg
...
authors-of-50-percent = $temp/50-percent.csv
authors-of-60-percent = $temp/60-percent.csv
authors-of-70-percent = $temp/70-percent.csv
authors-of-80-percent = $temp/80-percent.csv
authors-of-90-percent = $temp/90-percent.csv
authors-of-95-percent = $temp/95-percent.csv
...
contribution-tail = $temp/contrib-tail.csv
contributors = $temp/contributors-over-time.csv
contributors-per-release = $temp/contributors-per-release.csv
...
documentation-per-kloc = $temp/lines-per-docs.csv
examples = $temp/examples-over-time.csv
file-size = $temp/filesize-over-time.csv
files = $temp/files-over-time.csv
function-length = $temp/funclen.csv
...
lines-of-code = $temp/lines-over-time.csv
lines-of-code-delta = $temp/lines-per-month.csv
mail = $temp/mail.csv
...
remaining-authors = $temp/authorremains.csv
remaining-authors-toplist = $temp/authorremains.csv
...
test-infrastructure-per-kloc = $temp/testinfra-per-line.csv
test-infrastructure-per-test = $temp/testinfra-per-test.csv
tests = $temp/tests-over-time.csv
tests-per-kloc = $temp/lines-per-test.csv
third-parties = $temp/3rdparty-over-time.csv
todo = $temp/todo-over-time.csv
vulnerabilities-in-code = $temp/vuln-dist-code.csv
