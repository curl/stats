...
plot ARG1.'/strncpy-over-time.csv' using 1:3 with lines linestyle 3 title "strncpy total count" axis x1y2, \
ARG1.'/strncpy-over-time.csv' using 1:2 with lines linestyle 1 title "strncpy density"
