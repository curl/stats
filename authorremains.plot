...
plot ARG1.'/authorremains.csv' using 1:2 with lines linestyle 1 title "one line or more", \
 ARG1.'/authorremains.csv' using 1:3 with lines linestyle 2 title "10 lines or more", \
 ARG1.'/authorremains.csv' using 1:4 with lines linestyle 3 title "100 lines or more", \
 ARG1.'/authorremains.csv' using 1:5 with lines linestyle 4 title "1,000 lines or more", \
